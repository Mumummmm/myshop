            ...
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">${tbContentCategory.id == null ? "新增" : "修改"}内容</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form:form id="inputForm" cssClass="form-horizontal" action="/my_shop_web_admin_war_exploded/content/category/save" method="post" modelAttribute="tbContentCategory">
                        <form:hidden path="id" />
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="sortOrder" class="col-sm-2 col-form-label">分类排序</label>
                                <div class="col-sm-10">
